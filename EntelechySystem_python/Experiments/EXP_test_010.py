...
def main():
    # %% 配置项
    config = dict()
    config['folderpath_config'] = r"EntelechySystem_python/Libraries/ConfigsLibrary/config_test"  # 配置项文件夹路径
    config['foldername_engine'] = r"EntelechyEngine"  # 引擎所在工程文件夹名称
    config['foldername_CIS'] = r"EntelechyEngine"  # 引擎所在工程文件夹名称
    ...
    config['is_prerun_config_program'] = False  # 是否在实验主程序之前，预先运行了配置库相关的生成配置程序。默认 True；
