...
from EntelechySystem.Libraries.ModelsLibrary.model_111_numpy.model import Model
from EntelechySystem.Libraries.ModelsLibrary.model_111_numpy.model_define import ModelDefine
